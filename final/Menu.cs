...
public static class Menu
{
    public static void MostrarMenu()
    {
        ...
        Console.WriteLine("3. Calcular área y perimetro de un rectangulo.");
        Console.WriteLine("4. Determinar si un año es bisiesto.");
        Console.WriteLine("5. Encontrar el mayor de tres números.");
        ...
        Console.WriteLine("11. Ingresar 5 números válids.");
        Console.WriteLine("12. Animales hablando.");
        Console.WriteLine("13. Categorizár por edad.");
